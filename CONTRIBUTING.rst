...
Welcome to ``robin`` contributor's guide.
...
If you experience bugs or general issues with ``robin``, please have a look
...
You can help improve ``robin`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``robin`` documentation uses Sphinx_ as its main documentation compiler.
